...
* localrec - subparticle statistics: Reports histogram statistics from classified subparticles (e.g., number of parent particles with 0..N subparticles in selected class ID(s)).
