...
* localrec - subparticle statistics: Reports histogram statistics from classified subparticles (1D for one class-ID group, or 2D bubble plot for two class-ID groups) and exports results as ``histogram.json`` and ``histogram.csv``.
